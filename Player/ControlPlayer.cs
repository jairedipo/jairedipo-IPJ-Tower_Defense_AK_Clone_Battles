...
public class ControlPlayer : MonoBehaviour // Deixar as animações padrão para todos
{
    public int HP;
    public int HPMax;
    public int ATK;
    ...
    void Start()
    {
        ...
        torreInimiga = GameObject.FindGameObjectWithTag("TorreInimiga");
        DEFBonus = 1.0f;
    }
    ...
    void Update()
    {
        if (!morreu)
        {
            ...
            else
            {
                ...
                {
                    anim.SetBool("Atacar", true);
                    ControlEnemy inimigo = atacarInimigo.GetComponent<ControlEnemy>();
    ...
    void Atacar (ControlEnemy inimigo, int ATK, int VEL)
    {    
